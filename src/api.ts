...
export function getTopMovies() {
  return fetch(
    `${BASE_PATH}/movie/top_rated?api_key=${API_KEY}&page=1&include_adult=false&language=en-US`
  ).then((response) => response.json());
}
...
export function getPopularMovies2() {
  return fetch(
    `${BASE_PATH}/movie/popular?api_key=${API_KEY}&page=3&include_adult=false&language=en-US`
  ).then((response) => response.json());
}

export function getUpcomingMovies() {
  return fetch(
    `${BASE_PATH}/movie/upcoming?api_key=${API_KEY}&page=2&include_adult=false&language=en-US`
  ).then((response) => response.json());
}

export function getTvOnAir() {
  return fetch(
    `${BASE_PATH}/tv/on_the_air?api_key=${API_KEY}&page=1&include_adult=false&language=en-US`
  ).then((response) => response.json());
}

export function getTopTvs() {
  return fetch(
    `${BASE_PATH}/tv/top_rated?api_key=${API_KEY}&page=1&include_adult=false&language=en-US`
  ).then((response) => response.json());
}

export function getPopTvs() {
  return fetch(
    `${BASE_PATH}/tv/popular?api_key=${API_KEY}&page=5&include_adult=false&language=en-US`
  ).then((response) => response.json());
}

export function getAirTodayTvs() {
  return fetch(
    `${BASE_PATH}/tv/airing_today?api_key=${API_KEY}&page=2&include_adult=false&language=en-US`
  ).then((response) => response.json());
}
